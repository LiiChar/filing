...
>(({ className, ...props }, ref) => {
	...
	return (
		<div
			...
			ref={ref}
			className={cn(
				'h-full w-px bg-foreground absolute left-1.5 rtl:right-1.5 py-3 rounded-md hover:bg-slate-300 duration-300 ease-in-out',
				className
			)}
			{...props}
		/>
...
>(
	(
		...
		return (
			...
			>
				{showNested && (
					<div className='absolute before:border-[1px] before:block before:w-3 before:h-3 left-[-12px] before:border-foreground before:border-r-0 before:rounded-br-none before:rounded-tl-none before:border-t-0 before:rounded-sm'></div>
				)}
